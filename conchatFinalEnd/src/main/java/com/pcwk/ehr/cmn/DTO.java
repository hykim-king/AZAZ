...
public class DTO {
	...
	public long getGuelNo() {
		return guelNo;
	}

	public void setGuelNo(long guelNo) {
		this.guelNo = guelNo;
	}
	...
	public String toString() {
		return "DTO [guelNo=" + guelNo + ", totalCnt=" + totalCnt + ", pageSize=" + pageSize + ", pageNo=" + pageNo
