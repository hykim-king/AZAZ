...
public class UserController {
	...
	@RequestMapping(value="/moveToMatchedUser.do", method = RequestMethod.GET)
	public String moveToMatchedUser() throws SQLException {
		String view = "match/matched_user";
		LOG.debug("┌───────────────────────────────────────────┐");
		LOG.debug("│ moveToMatchedUser                                 │");
		LOG.debug("└───────────────────────────────────────────┘");	
