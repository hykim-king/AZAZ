...
<link type="text/css" rel="stylesheet" href="../resources/css/matching_tft.css"/>
...
<script >
    ...
    function doFindLolcheNickname(){
        console.log("----------------------------");
        console.log("-------doFindLolcheNickname-------");
        console.log("----------------------------");
        
        return $.ajax({
            type: "GET",
            url: "/ehr/match/doFindLolcheNickname.do",
            async: true,
            dataType: "html",
            data: {
                id: matchedId
...
<body class ="inner-box bg-game">
    <div class="title-box mb20">
        ...
        <div class="grid grid-cols-3 gap-4 mb20">
            ...
            <div>
                <label for="chat" class="m-text">적극성</label>
