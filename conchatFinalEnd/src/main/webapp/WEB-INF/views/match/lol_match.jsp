...
<link type="text/css" rel="stylesheet" href="../resources/css/matching_lol.css"/>
<link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
    
<style>

</style>
<title>리그 오브 레전드 매칭</title>
...
<script >
    ...
    function doFindLolNickname(){
        console.log("----------------------------");
        console.log("-------doFindLolNickname-------");
        console.log("----------------------------");
        
        return $.ajax({
            type: "GET",
            url: "/ehr/match/doFindLolNickname.do",
            async: true,
            dataType: "html",
            data: {
                id: matchedId
...
<body class ="inner-box bg-game">
        ...
        <div class="grid grid-cols-3 gap-4 mb20">
            <div>
                ...
                <select title="적극성" id = "tier">
                    ...
                    <option value="6">      다이아</option>
                </select>
            </div>
            <div>
                <label for="chat" class="p-label m-text mb20">음성채팅</label>
            ...
            <div>
                <label for="act" class="p-label m-text" >적극성</label>
        ...
        <div class="mb40 tac">
            <input class="my-btn blue-white" type="button" value="매칭시작"  onclick="window.doUpdate();"/> 
            <input class="my-btn red-white" type="button" value="돌아가기" onclick="closeTabClick()"/> 
        </div>
