            ...
            <div class="inner-box">
                <div class="contents-box">
                    ...
                    <div class="line-bottom">
                        <h1 class="sub-section-title">발로란트 닉네임 수정</h1>
                    </div>
                        ...
                        <form class="pw-edit-form ">
                            <table>
                                ...
                                <tr>
                                    <th>변경할 닉네임</th>
                                    <td>
                                        <input type="text"   placeholder="변경할 닉네임을 입력하세요" title="valnick"
                                        name="valnick" id="valnick">
                                    </td>
                                </tr>                               
                                <tr>
                                    <td colspan="3" class="tac">
                                        <input class="my-btn blue-white mb20" type="button" value="변경하기" id="doSave"     onclick="window.changeVal()">                                               
